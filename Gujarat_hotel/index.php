...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:hotel.gujarat00@gmail.com">hotel.gujarat00@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 6359402483</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="Index.php">GUJARAT <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">GUJARAT HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our HOTEL GUJARAT</h3> 
		   ...
		   <div class="advantage-bottom">
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					...
					<p><i class="fa fa-check" aria-hidden="true"></i>24-hour Medical service</p>
			 	</div>
			 </div>
			<div class="clearfix"> </div>
			</div>
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>RS</span>3200</h3>						
                                                                <a href="admin/superior.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h3><span>RS</span>2200</h3>
                                                                <a href="admin/deluxe.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h3><span>RS</span>1800</h3>
                                                                <a href="admin/guesthouse.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h3><span>RS</span> 1500</h3>
                                                                <a href="admin/single.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 6359402483</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:hotel.gujarat00@gmail.com">hotel.gujarat00@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Vesu Road, Surat, Gujarat</p>
...
<!-- /contact -->
			<div class="copy">
                            <p>Â© 2021 GUJARAT HOTEL . All Rights Reserved | Design by <a href="Index.php">GUJARAT HOTEL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
