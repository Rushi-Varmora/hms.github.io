...
<head>
  <meta charset="UTF-8">
  <title>GUJARAT HOTEL ADMIN</title>
...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom"> <br><br><br><br><h4><a href="../index.php">GUJARAT HOTEL HOMEPAGE</a></h4></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $mypassword = mysqli_real_escape_string($con, md5($_POST['pass'])); 
